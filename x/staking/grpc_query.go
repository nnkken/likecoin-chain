...
func (q *Querier) ValidatorDelegations(c context.Context, req *types.QueryValidatorDelegationsRequest) (*types.QueryValidatorDelegationsResponse, error) {
	...
	// TODO: this shit is doing queries so many times that it should be optimized
	// delResponses, err := keeper.DelegationsToDelegationResponses(ctx, *q.keeper, delegations)
	// if err != nil {
